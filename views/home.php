...
<body>
  <section class="contenedorHome">
    ...
    <article class="contenedorOpciones">

      <a href="<?php echo SERVER; ?>crearProceso/" class="opcion">
      ...
      <button type="submit" class="btn-outline btn">
        <a class="opcion" href="<?php echo SERVER; ?>consultarProcesos/"><i class="bi bi-search"></i>Consultar</a>
      </button>
    </article>
